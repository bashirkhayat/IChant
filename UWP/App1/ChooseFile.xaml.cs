...
namespace App1
{
    ...
    /// </summary>
    public sealed partial class ChooseFile : Page
    {
    ...
    App_BackRequested;
            ...
            storageAccount = CloudStorageAccount.Parse("DefaultEndpointsProtocol=https;AccountName=midicollection;AccountKey=pbgDEyfKCVyqVpAP7aKFhiEayhrXrjPOUUxmMOXuDxu8kqSLPk72m07tGi2gOuacV0+onC9AAqiTDpjX8SRvEg==;EndpointSuffix=core.windows.net");
        ...
        async void update()
        {
            ...
            CloudBlobContainer container = blobClient.GetContainerReference("midicollection");
            ...
            midiCollection.ItemsSource = collection;
        }
        ...
        private void App_BackRequested(object sender,Windows.UI.Core.BackRequestedEventArgs e)
        {
            ...
            {
                e.Handled = true;
                rootFrame.Navigate(typeof(MainPage),player);
                //rootFrame.GoBack();
            }
        }
